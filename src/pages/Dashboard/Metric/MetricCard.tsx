...
export default function MetricCard({ metric, message, value, urgentStatus }: Vital) {
  ...
  return (
    <article className="box-border flex w-full min-w-[400px] flex-row items-center justify-between gap-x-2 rounded-[10px] border-[1px] border-solid border-[#EBEEEE] bg-[#F8F9FA] p-3 px-6">
      ...
      <div className="box-border flex basis-1/5 flex-row items-center gap-x-3">
        {value && (
          <span
